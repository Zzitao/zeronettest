...
class ActionsPlugin(object):
    ...
    def main(self):
        ...
        icon.items = [
            ...
            # "--",
            (_["ZeroNet Twitter"], lambda: self.opensite("https://twitter.com/SuperBTC2")),
            (_["ZeroNet Reddit"], lambda: self.opensite("http://www.reddit.com/r/zeronet/")),
            (_["ZeroNet Github"], lambda: self.opensite("https://github.com/Zzitao/ZeroNet")),
            (_["Report bug/request feature"], lambda: self.opensite("https://github.com/Zzitao/ZeroNet/issues")),
            "--",
